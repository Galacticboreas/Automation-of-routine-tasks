"""
непосредственное использование виджетов Entry и размещение их по
рядам с метками фиксированной ширины: такой способ компоновки, а
также использование менеджера grid обеспечивают наилучшее
представление для форм
"""

from tkinter import LEFT, RIGHT, TOP, YES, Button, Entry, Frame, Label, Tk, X
