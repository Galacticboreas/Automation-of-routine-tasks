"""
содает два связанных ползунка для запуска демонстрационных диалога
"""

from tkinter import *           # импортировать базовый набор виджетов
from dialogTable import demos   # обработчики событий
from quitter import Quitter     # приерепить к "себе" объект Quitter
